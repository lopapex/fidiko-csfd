...
const LEGACY_RADAR_CACHE_KEYS = ["current-v11", "current-v10", "current-v9", "current-v8", "current-v7", "current-v6", "current-v5", "current-v4", "current-v3", "current-v2"];
const LEGACY_WEEK_CACHE_VERSIONS = ["week-v10", "week-v9", "week-v8", "week-v7", "week-v6", "week-v5", "week-v4", "week-v3", "week-v2", "week-v1"];
